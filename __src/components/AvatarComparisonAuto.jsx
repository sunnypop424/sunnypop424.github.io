        ...
        <div className="avatar">
            <div className="wrapper">
                <div className="avatar-comparison">
                    ...
                    <div className="flex items-center gap-3" style={{marginBottom: 0, borderBottom: 0}}>
                    ...
                    <button className="btn btn-primary" onClick={fetchPrices} disabled={loading}>
                                    ...
                                    const getDiffLabel = (value) => {
                                        ...
                                        return (
                                            <span className="badge">
                                                최저가보다 {Math.round(diff).toLocaleString()}<span className="chip-yellow">골드</span> 비쌈
                                            </span>
                                        );
                                    };
                                        ...
                                        <div className="price-result" key={groupKey}>
                                            ...
                                            <div className="avatar-info">
                                                ...
                                                <ul>
                                                                    ...
                                                                    <p>
                                                                        <span className="price-summary">
                                                                            <strong className={total === minValue ? 'best' : ''}>
                                                                                ...
                                                                                <span className="chip-yellow">골드</span>
                                                                            </strong>
                                                                            <span className="price-calcul">
                                                                                ({price.toLocaleString()}<span className="chip-yellow">골드</span>
                                                                                {isPeonNeeded && (
                                                                                    <>
                                                                                        {' + '}
                                                                                        {Math.round(peonCost).toLocaleString()}
                                                                                        <span className="chip-yellow">골드</span>
                                                                                        {' ('}{peons}<span className="chip-emerald">페온</span>)
                                                                                    </>
                                                                                )}) &nbsp;
                                                                            </span>
                                                                        </span>
                                                    ...
                                                    {items['정보 없음'] && (
                                                        <li><p className="left">아바타 상자</p><p>{items['정보 없음'].toLocaleString()}<span className="chip-yellow">골드</span></p></li>
                                                    )}
                                                </ul>
                                            </div>
                                        </div>
