                    ...
                    {result ? (
                        <>
                            <div className="price-result flex-c">
                                ...
                                <ul className="chip-indigo">
                                    {result.breakdown.map((item, idx) => (
                                        <li key={idx}>
                                            <p><span className="chip-emerald">페온</span><strong>{item.name}</strong> × {item.count}개</p><p>{item.totalCrystals.toLocaleString()}<span className="chip-cyan"> 크리스탈</span></p>
                                        </li>
                                    ))}
                                </ul>
                            </div>
                            <div className="price-result flex-c">
                                <h3>총 비용</h3>
                                <ul className="chip-pink">
                                    <li>
                                        <p>총 골드 소모</p><p><strong>{Math.round(result.totalGold).toLocaleString()}</strong><span className="chip-yellow"> G</span></p>
                                    </li>
                                </ul>
                                <ul>
                                    <li>
                                        <p>총 크리스탈 필요량</p><p><strong>{result.totalCrystals.toLocaleString()}</strong><span className="chip-cyan"> 크리스탈</span></p>
                                    </li>
                                    <li>
                                        <p>1 크리스탈당 골드</p><p><strong>{result.crystalRate.toFixed(2)}</strong><span className="chip-yellow"> G</span></p>
                                    </li>
                                    <li>
                                        <p>1 페온당 평균 골드</p><p><strong>{result.avgGoldPerPeon.toFixed(2)}</strong><span className="chip-yellow"> G</span></p>
                                    </li>
                                    {result.leftoverPeons > 0 && (
                                        <li>
                                            <p>남는 페온</p><p><strong>{result.leftoverPeons.toLocaleString()}</strong><span className="chip-emerald">페온</span></p>
                                        </li>
                                    )}
                                </ul>
                            </div>
